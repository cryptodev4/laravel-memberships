...
namespace CryptoDev4\LaravelSubscriptions\Traits;

use Carbon\Carbon;
use CryptoDev4\LaravelSubscriptions\Models\Plan;
use CryptoDev4\LaravelSubscriptions\Services\Period;
use Illuminate\Database\Eloquent\Collection;
use CryptoDev4\LaravelSubscriptions\Models\PlanSubscription;
...
trait HasPlanSubscriptions
{
    ...
    {
        return $this->morphMany(config('cryptodev4.laravel-subscriptions.models.plan_subscription'), 'subscriber', 'subscriber_type', 'subscriber_id');
    }
     ...
     *
     * @return \CryptoDev4\LaravelSubscriptions\Models\PlanSubscription|null
     */
    ...
    public function subscribedPlans(): Collection
    {
        ...
        return app('cryptodev4.laravel-subscriptions.plan')->whereIn('id', $planIds)->get();
    }
     ...
     *
     * @return \CryptoDev4\LaravelSubscriptions\Models\PlanSubscription
     */
