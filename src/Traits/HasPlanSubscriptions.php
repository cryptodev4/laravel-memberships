...
namespace CryptoDev4\Subscriptions\Traits;
...
trait HasPlanSubscriptions
{
    ...
    {
        return $this->morphMany(config('cryptodev4.subscriptions.models.plan_subscription'), 'subscriber', 'subscriber_type', 'subscriber_id');
    }
     ...
     *
     * @return \CryptoDev4\Subscriptions\Models\PlanSubscription|null
     */
    ...
    public function subscribedPlans(): Collection
    {
        ...
        return app('cryptodev4.subscriptions.plan')->whereIn('id', $planIds)->get();
    }
     ...
     *
     * @return \CryptoDev4\Subscriptions\Models\PlanSubscription
     */
